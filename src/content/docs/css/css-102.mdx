...
<details>
  ...
  <HtmlOutput>
    <p style={{ color: "tomato" }}>Lorem ipsum dolor sit amet consectetur adipiscing elit facilisi cum
      malesuada accumsan</p>
    <p style={{ color: "dodgerblue" }}>Tortor tellus facilisis tristique dapibus vehicula sociis iaculis
      dignissim augue interdum purus euismod fermentum natoque</p>
  </HtmlOutput>
</details>
...
<details>
  <summary>Toggle me!</summary>
  <HtmlOutput>
    <p style={{ color: "dodgerblue", border: "3px solid rebeccapurple" }}>Tortor tellus facilisis tristique dapibus vehicula sociis iaculis
      dignissim augue interdum purus euismod fermentum natoque</p>
  </HtmlOutput>
</details>
...
<details>
  ...
  <HtmlOutput>
    <p
      ...
      }}>Metus orci ultrices tempor platea ut pharetra mus accumsan.</p>
    <p
      style={{
        borderStyle: "solid",
...
<details>
  ...
  <HtmlOutput>
    ...
    >A solid red border</p>
    <p
      style={{
        borderStyle: "solid",
        borderColor: "red",
      }}
    >A solid green border</p>
    <p
      style={{
        borderStyle: "solid",
        borderColor: "red",
      }}
    >A dotted blue border</p>
    <p>
...
<details>
  ...
  <HtmlOutput>
    ...
    <p style={{ textAlign: "right" }}>Lorem ipsum dolor sit amet consectetur adipiscing elit facilisi cum
      malesuada accumsan</p>
    <p style={{ textAlign: "justify" }}>Tortor tellus facilisis tristique dapibus vehicula sociis iaculis dignissim
  augue interdum purus euismod fermentum natoque.
  Eleifend consequat curae metus lectus parturient sodales est praesent justo, vivamus dictum vulputate aliquam egestas convallis porttitor in, tincidunt arcu vitae litora taciti leo posuere suscipit.</p>
  </HtmlOutput>
</details>
...
<details>
  <summary>Toggle me!</summary>
  <HtmlOutput>
    <p style={{ textDecorationLine: "underline", textDecorationColor: "red" }}>This text has a red underline.</p>
  </HtmlOutput>
</details>
...
<details>
  ...
  <HtmlOutput>
    ...
    >This text has a dotted underline.</p>
  </HtmlOutput>
</details>
...
<details>
  ...
  <HtmlOutput>
    ...
    >This text has a thick underline.</p>
  </HtmlOutput>
</details>
...
<details>
  <summary>Toggle me!</summary>
  <HtmlOutput>
    <p style={{ textDecoration: "underline red dotted 3px" }}>This text has a red, dotted, thick underline.</p>
  </HtmlOutput>
</details>
